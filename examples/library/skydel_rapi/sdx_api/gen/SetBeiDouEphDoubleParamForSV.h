...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetBeiDouEphDoubleParamForSV(int svId, const std::string& paramName, double val);
  
      static SetBeiDouEphDoubleParamForSVPtr create(int svId, const std::string& paramName, double val);
