...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetGalileoPerturbationsForAllSat;
    typedef std::shared_ptr<SetGalileoPerturbationsForAllSat> SetGalileoPerturbationsForAllSatPtr;
    
    
    class SetGalileoPerturbationsForAllSat : public CommandBase
    {
    public:
      ...
      SetGalileoPerturbationsForAllSat();

      SetGalileoPerturbationsForAllSat(const std::vector<double>& crs, const std::vector<double>& crc, const std::vector<double>& cis, const std::vector<double>& cic, const std::vector<double>& cus, const std::vector<double>& cuc);
  
      static SetGalileoPerturbationsForAllSatPtr create(const std::vector<double>& crs, const std::vector<double>& crc, const std::vector<double>& cis, const std::vector<double>& cic, const std::vector<double>& cus, const std::vector<double>& cuc);
      static SetGalileoPerturbationsForAllSatPtr dynamicCast(CommandBasePtr ptr);
