...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetGpsEphBoolParamForEachSV;
    typedef std::shared_ptr<SetGpsEphBoolParamForEachSV> SetGpsEphBoolParamForEachSVPtr;
    
    
    class SetGpsEphBoolParamForEachSV : public CommandBase
    {
    public:
      ...
      SetGpsEphBoolParamForEachSV(const std::string& paramName, const std::vector<bool>& val);
  
      static SetGpsEphBoolParamForEachSVPtr create(const std::string& paramName, const std::vector<bool>& val);
