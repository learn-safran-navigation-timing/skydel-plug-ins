...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetQzssEphDoubleParamForSV(int svId, const std::string& paramName, double val);
  
      static SetQzssEphDoubleParamForSVPtr create(int svId, const std::string& paramName, double val);
