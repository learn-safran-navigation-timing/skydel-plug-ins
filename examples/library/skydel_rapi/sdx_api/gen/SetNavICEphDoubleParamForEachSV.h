...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetNavICEphDoubleParamForEachSV(const std::string& paramName, const std::vector<double>& val);
  
      static SetNavICEphDoubleParamForEachSVPtr create(const std::string& paramName, const std::vector<double>& val);
