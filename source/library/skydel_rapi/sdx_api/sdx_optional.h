...
{
public:
  optional() : m_isSet(false), m_value() {}

  optional(T value) { set(value); }

  optional(const optional& other) : m_isSet(other.m_isSet), m_value(other.m_value) {}
  ...
  bool operator==(T other) const { return m_isSet && m_value == other; }
