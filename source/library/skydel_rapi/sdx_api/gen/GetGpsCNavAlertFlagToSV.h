...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetGpsCNavAlertFlagToSV(int svId, const std::optional<std::string>& dataSetName = {});

      static GetGpsCNavAlertFlagToSVPtr create(int svId, const std::optional<std::string>& dataSetName = {});
