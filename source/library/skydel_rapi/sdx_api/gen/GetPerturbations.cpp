...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetPerturbations::GetPerturbations(const std::string& system, int svId, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetPerturbationsPtr GetPerturbations::create(const std::string& system, int svId, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetPerturbations::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetPerturbations::setDataSetName(const std::optional<std::string>& dataSetName)
    {
