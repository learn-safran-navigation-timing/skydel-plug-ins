...
namespace Sdx
{
  namespace Cmd
  {
    ...
    IsLogNmeaEnabledResult::IsLogNmeaEnabledResult(bool enabled, const std::optional<bool>& serialPortEnabled)
      : CommandResult(CmdName, TargetId)
    {
    ...
    IsLogNmeaEnabledResult::IsLogNmeaEnabledResult(CommandBasePtr relatedCommand, bool enabled, const std::optional<bool>& serialPortEnabled)
    ...
    IsLogNmeaEnabledResultPtr IsLogNmeaEnabledResult::create(bool enabled, const std::optional<bool>& serialPortEnabled)
    {
      return std::make_shared<IsLogNmeaEnabledResult>(enabled, serialPortEnabled);
    }

    IsLogNmeaEnabledResultPtr IsLogNmeaEnabledResult::create(CommandBasePtr relatedCommand, bool enabled, const std::optional<bool>& serialPortEnabled)
    {
    ...
    std::optional<bool> IsLogNmeaEnabledResult::serialPortEnabled() const
    {
