...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetGpsNavAlertFlagForSVResult(CommandBasePtr relatedCommand, int svId, bool alert, const std::optional<std::string>& dataSetName = {});

      static GetGpsNavAlertFlagForSVResultPtr create(int svId, bool alert, const std::optional<std::string>& dataSetName = {});

      static GetGpsNavAlertFlagForSVResultPtr create(CommandBasePtr relatedCommand, int svId, bool alert, const std::optional<std::string>& dataSetName = {});
    ...
    REGISTER_COMMAND_TO_FACTORY_DECL(GetGpsNavAlertFlagForSVResult);
  }
}
