...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetQzssSatelliteL1DataHealth(int svId, const std::optional<std::string>& dataSetName = {});

      static GetQzssSatelliteL1DataHealthPtr create(int svId, const std::optional<std::string>& dataSetName = {});
