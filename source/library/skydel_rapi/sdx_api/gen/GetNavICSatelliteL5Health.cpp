...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetNavICSatelliteL5Health::GetNavICSatelliteL5Health(int svId, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetNavICSatelliteL5HealthPtr GetNavICSatelliteL5Health::create(int svId, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetNavICSatelliteL5Health::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetNavICSatelliteL5Health::setDataSetName(const std::optional<std::string>& dataSetName)
    {
