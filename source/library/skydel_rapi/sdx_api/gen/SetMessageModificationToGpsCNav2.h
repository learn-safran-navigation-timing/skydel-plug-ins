...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetMessageModificationToGpsCNav2;
    typedef std::shared_ptr<SetMessageModificationToGpsCNav2> SetMessageModificationToGpsCNav2Ptr;
    
    
    class SetMessageModificationToGpsCNav2 : public CommandBase
    {
    public:
      ...
      SetMessageModificationToGpsCNav2(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, int page, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);

      static SetMessageModificationToGpsCNav2Ptr create(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, int page, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);
      static SetMessageModificationToGpsCNav2Ptr dynamicCast(CommandBasePtr ptr);
