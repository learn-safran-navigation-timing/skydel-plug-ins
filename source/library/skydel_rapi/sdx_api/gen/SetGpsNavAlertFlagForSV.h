...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetGpsNavAlertFlagForSV(int svId, bool alert, const std::optional<std::string>& dataSetName = {});

      static SetGpsNavAlertFlagForSVPtr create(int svId, bool alert, const std::optional<std::string>& dataSetName = {});
