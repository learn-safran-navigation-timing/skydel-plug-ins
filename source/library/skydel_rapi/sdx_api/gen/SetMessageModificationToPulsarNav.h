...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetMessageModificationToPulsarNav;
    typedef std::shared_ptr<SetMessageModificationToPulsarNav> SetMessageModificationToPulsarNavPtr;
    
    
    class SetMessageModificationToPulsarNav : public CommandBase
    {
    public:
      ...
      SetMessageModificationToPulsarNav();

      SetMessageModificationToPulsarNav(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);

      static SetMessageModificationToPulsarNavPtr create(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);
      static SetMessageModificationToPulsarNavPtr dynamicCast(CommandBasePtr ptr);
