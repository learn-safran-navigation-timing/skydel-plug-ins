...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetQzssEphemerisDoubleParam(int svId, const std::string& paramName, const std::optional<std::string>& dataSetName = {});

      static GetQzssEphemerisDoubleParamPtr create(int svId, const std::string& paramName, const std::optional<std::string>& dataSetName = {});
