...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetQzssL1DataHealthForSV(int svId, int health, const std::optional<std::string>& dataSetName = {});

      static SetQzssL1DataHealthForSVPtr create(int svId, int health, const std::optional<std::string>& dataSetName = {});
