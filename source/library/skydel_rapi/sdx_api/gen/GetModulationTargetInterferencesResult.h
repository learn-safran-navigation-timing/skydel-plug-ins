...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetModulationTargetInterferencesResult(int output, int minRate, int maxRate, int group, double centralFreq, int gain, const std::string& id, const Sdx::optional<std::string>& signal = {});
      ...
      static GetModulationTargetInterferencesResultPtr create(int output, int minRate, int maxRate, int group, double centralFreq, int gain, const std::string& id, const Sdx::optional<std::string>& signal = {});
