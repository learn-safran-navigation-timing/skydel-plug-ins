...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetQzssL1DataHealthForSV::SetQzssL1DataHealthForSV(int svId, int health, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetQzssL1DataHealthForSVPtr SetQzssL1DataHealthForSV::create(int svId, int health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetQzssL1DataHealthForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetQzssL1DataHealthForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
