...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetGpsL2HealthForSVResult(int svId, bool health, const std::optional<std::string>& dataSetName = {});

      GetGpsL2HealthForSVResult(CommandBasePtr relatedCommand, int svId, bool health, const std::optional<std::string>& dataSetName = {});

      static GetGpsL2HealthForSVResultPtr create(int svId, bool health, const std::optional<std::string>& dataSetName = {});

      static GetGpsL2HealthForSVResultPtr create(CommandBasePtr relatedCommand, int svId, bool health, const std::optional<std::string>& dataSetName = {});
