...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetGpsEphemerisBoolParams(const std::string& paramName, const std::vector<bool>& val);
  
      static SetGpsEphemerisBoolParamsPtr create(const std::string& paramName, const std::vector<bool>& val);
