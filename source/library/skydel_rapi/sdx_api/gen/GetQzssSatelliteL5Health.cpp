...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetQzssSatelliteL5Health::GetQzssSatelliteL5Health(int svId, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetQzssSatelliteL5HealthPtr GetQzssSatelliteL5Health::create(int svId, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetQzssSatelliteL5Health::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetQzssSatelliteL5Health::setDataSetName(const std::optional<std::string>& dataSetName)
    {
