...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetQzssEphBoolParamForSVResult::GetQzssEphBoolParamForSVResult(int svId, const std::string& paramName, bool val, const std::optional<std::string>& dataSetName)
      : CommandResult(CmdName, TargetId)
    {
    ...
    GetQzssEphBoolParamForSVResult::GetQzssEphBoolParamForSVResult(CommandBasePtr relatedCommand, int svId, const std::string& paramName, bool val, const std::optional<std::string>& dataSetName)
    ...
    GetQzssEphBoolParamForSVResultPtr GetQzssEphBoolParamForSVResult::create(int svId, const std::string& paramName, bool val, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<GetQzssEphBoolParamForSVResult>(svId, paramName, val, dataSetName);
    }

    GetQzssEphBoolParamForSVResultPtr GetQzssEphBoolParamForSVResult::create(CommandBasePtr relatedCommand, int svId, const std::string& paramName, bool val, const std::optional<std::string>& dataSetName)
    {
    ...
    {
      setValue("Val", parse_json<bool>::format(val, m_values.GetAllocator()));
    }



    std::optional<std::string> GetQzssEphBoolParamForSVResult::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetQzssEphBoolParamForSVResult::setDataSetName(const std::optional<std::string>& dataSetName)
    {
