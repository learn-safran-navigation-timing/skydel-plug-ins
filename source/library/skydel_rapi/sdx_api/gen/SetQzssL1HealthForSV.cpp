...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetQzssL1HealthForSV::SetQzssL1HealthForSV(int svId, bool health, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetQzssL1HealthForSVPtr SetQzssL1HealthForSV::create(int svId, bool health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetQzssL1HealthForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetQzssL1HealthForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
