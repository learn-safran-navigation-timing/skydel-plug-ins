...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetGpsSignalHealthForSV::SetGpsSignalHealthForSV(int svId, int health, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetGpsSignalHealthForSVPtr SetGpsSignalHealthForSV::create(int svId, int health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetGpsSignalHealthForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetGpsSignalHealthForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
