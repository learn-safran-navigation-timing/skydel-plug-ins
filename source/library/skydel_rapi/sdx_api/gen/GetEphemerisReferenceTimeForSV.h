...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetEphemerisReferenceTimeForSV(const std::string& system, int svId, const std::optional<std::string>& dataSetName = {});

      static GetEphemerisReferenceTimeForSVPtr create(const std::string& system, int svId, const std::optional<std::string>& dataSetName = {});
