...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetGalileoSisaE1E5bIndexForSV(int svId, int sisai, const std::optional<std::string>& dataSetName = {});

      static SetGalileoSisaE1E5bIndexForSVPtr create(int svId, int sisai, const std::optional<std::string>& dataSetName = {});
