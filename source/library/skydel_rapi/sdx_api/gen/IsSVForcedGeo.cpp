...
namespace Sdx
{
  namespace Cmd
  {
    ...
    IsSVForcedGeo::IsSVForcedGeo(const std::string& system, int svId, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    IsSVForcedGeoPtr IsSVForcedGeo::create(const std::string& system, int svId, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> IsSVForcedGeo::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void IsSVForcedGeo::setDataSetName(const std::optional<std::string>& dataSetName)
    {
