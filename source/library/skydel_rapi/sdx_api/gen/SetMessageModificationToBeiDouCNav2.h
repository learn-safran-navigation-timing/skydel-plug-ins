...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetMessageModificationToBeiDouCNav2;
    typedef std::shared_ptr<SetMessageModificationToBeiDouCNav2> SetMessageModificationToBeiDouCNav2Ptr;
    
    
    class SetMessageModificationToBeiDouCNav2 : public CommandBase
    {
    public:
      ...
      SetMessageModificationToBeiDouCNav2(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, int messageType, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);

      static SetMessageModificationToBeiDouCNav2Ptr create(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, int messageType, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);
      static SetMessageModificationToBeiDouCNav2Ptr dynamicCast(CommandBasePtr ptr);
