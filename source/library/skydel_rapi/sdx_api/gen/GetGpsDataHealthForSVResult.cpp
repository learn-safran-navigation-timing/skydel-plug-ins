...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGpsDataHealthForSVResult::GetGpsDataHealthForSVResult(int svId, int health, const std::optional<std::string>& dataSetName)
      : CommandResult(CmdName, TargetId)
    {
    ...
    GetGpsDataHealthForSVResult::GetGpsDataHealthForSVResult(CommandBasePtr relatedCommand, int svId, int health, const std::optional<std::string>& dataSetName)
    ...
    GetGpsDataHealthForSVResultPtr GetGpsDataHealthForSVResult::create(int svId, int health, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<GetGpsDataHealthForSVResult>(svId, health, dataSetName);
    }

    GetGpsDataHealthForSVResultPtr GetGpsDataHealthForSVResult::create(CommandBasePtr relatedCommand, int svId, int health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGpsDataHealthForSVResult::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGpsDataHealthForSVResult::setDataSetName(const std::optional<std::string>& dataSetName)
    {
