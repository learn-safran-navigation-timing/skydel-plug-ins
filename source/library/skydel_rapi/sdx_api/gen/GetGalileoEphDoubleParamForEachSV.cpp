...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGalileoEphDoubleParamForEachSV::GetGalileoEphDoubleParamForEachSV(const std::string& paramName, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetGalileoEphDoubleParamForEachSVPtr GetGalileoEphDoubleParamForEachSV::create(const std::string& paramName, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGalileoEphDoubleParamForEachSV::deprecated() const { return std::optional<std::string>{Deprecated}; }
    ...
    std::optional<std::string> GetGalileoEphDoubleParamForEachSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGalileoEphDoubleParamForEachSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
