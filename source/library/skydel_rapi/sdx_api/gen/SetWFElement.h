...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetWFElement(int element, bool enabled, const std::string& antennaModelName, const std::optional<int>& lnaGain = {}, const std::optional<bool>& isGaussianNoiseEnabled = {}, const std::optional<double>& gaussianNoisePowerDensityOffset = {});

      static SetWFElementPtr create(int element, bool enabled, const std::string& antennaModelName, const std::optional<int>& lnaGain = {}, const std::optional<bool>& isGaussianNoiseEnabled = {}, const std::optional<double>& gaussianNoisePowerDensityOffset = {});
