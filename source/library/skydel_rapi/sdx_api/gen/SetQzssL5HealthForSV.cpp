...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetQzssL5HealthForSV::SetQzssL5HealthForSV(int svId, bool health, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetQzssL5HealthForSVPtr SetQzssL5HealthForSV::create(int svId, bool health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetQzssL5HealthForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetQzssL5HealthForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
