...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetConstellationParameterForEachSV::SetConstellationParameterForEachSV(const std::string& system, const std::string& paramName, const std::vector<double>& val, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetConstellationParameterForEachSV::SetConstellationParameterForEachSV(const std::string& system, const std::string& paramName, const std::vector<int>& val, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetConstellationParameterForEachSV::SetConstellationParameterForEachSV(const std::string& system, const std::string& paramName, const std::vector<bool>& val, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetConstellationParameterForEachSVPtr SetConstellationParameterForEachSV::create(const std::string& system, const std::string& paramName, const std::vector<double>& val, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<SetConstellationParameterForEachSV>(system, paramName, val, dataSetName);
    }

    SetConstellationParameterForEachSVPtr SetConstellationParameterForEachSV::create(const std::string& system, const std::string& paramName, const std::vector<int>& val, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<SetConstellationParameterForEachSV>(system, paramName, val, dataSetName);
    }

    SetConstellationParameterForEachSVPtr SetConstellationParameterForEachSV::create(const std::string& system, const std::string& paramName, const std::vector<bool>& val, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<SetConstellationParameterForEachSV>(system, paramName, val, dataSetName);
    }
    ...
    std::optional<std::string> SetConstellationParameterForEachSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetConstellationParameterForEachSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
