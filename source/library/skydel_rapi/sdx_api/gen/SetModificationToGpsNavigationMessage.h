...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetModificationToGpsNavigationMessage;
    typedef std::shared_ptr<SetModificationToGpsNavigationMessage> SetModificationToGpsNavigationMessagePtr;
    
    
    class SetModificationToGpsNavigationMessage : public CommandBase
    {
    public:
      ...
      SetModificationToGpsNavigationMessage();

      SetModificationToGpsNavigationMessage(int prn, int startTime, int stopTime, int subFrame, int page, int word, bool updateParity, const std::string& modification, const std::string& id);
  
      static SetModificationToGpsNavigationMessagePtr create(int prn, int startTime, int stopTime, int subFrame, int page, int word, bool updateParity, const std::string& modification, const std::string& id);
      static SetModificationToGpsNavigationMessagePtr dynamicCast(CommandBasePtr ptr);
