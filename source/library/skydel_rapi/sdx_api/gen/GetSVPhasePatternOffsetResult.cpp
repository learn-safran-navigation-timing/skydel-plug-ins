...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetSVPhasePatternOffsetResult::GetSVPhasePatternOffsetResult(const Sdx::GNSSBand& band, const std::string& system, double offset, const std::optional<std::string>& antennaName)
      : CommandResult(CmdName, TargetId)
    {
    ...
    GetSVPhasePatternOffsetResult::GetSVPhasePatternOffsetResult(CommandBasePtr relatedCommand, const Sdx::GNSSBand& band, const std::string& system, double offset, const std::optional<std::string>& antennaName)
    ...
    GetSVPhasePatternOffsetResultPtr GetSVPhasePatternOffsetResult::create(const Sdx::GNSSBand& band, const std::string& system, double offset, const std::optional<std::string>& antennaName)
    {
      return std::make_shared<GetSVPhasePatternOffsetResult>(band, system, offset, antennaName);
    }

    GetSVPhasePatternOffsetResultPtr GetSVPhasePatternOffsetResult::create(CommandBasePtr relatedCommand, const Sdx::GNSSBand& band, const std::string& system, double offset, const std::optional<std::string>& antennaName)
    {
    ...
    std::optional<std::string> GetSVPhasePatternOffsetResult::antennaName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["AntennaName"]);
    }

    void GetSVPhasePatternOffsetResult::setAntennaName(const std::optional<std::string>& antennaName)
    {
      setValue("AntennaName", parse_json<std::optional<std::string>>::format(antennaName, m_values.GetAllocator()));
    }
