...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetQzssEphemerisBoolParam(int svId, const std::string& paramName, bool val);
  
      static SetQzssEphemerisBoolParamPtr create(int svId, const std::string& paramName, bool val);
