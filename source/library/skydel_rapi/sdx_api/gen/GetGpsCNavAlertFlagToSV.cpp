...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGpsCNavAlertFlagToSV::GetGpsCNavAlertFlagToSV(int svId, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetGpsCNavAlertFlagToSVPtr GetGpsCNavAlertFlagToSV::create(int svId, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGpsCNavAlertFlagToSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGpsCNavAlertFlagToSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
