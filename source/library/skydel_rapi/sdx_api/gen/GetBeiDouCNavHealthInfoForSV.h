...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetBeiDouCNavHealthInfoForSV(int svId, const std::optional<std::string>& dataSetName = {});

      static GetBeiDouCNavHealthInfoForSVPtr create(int svId, const std::optional<std::string>& dataSetName = {});
