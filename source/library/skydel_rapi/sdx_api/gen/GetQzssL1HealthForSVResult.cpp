...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetQzssL1HealthForSVResult::GetQzssL1HealthForSVResult(int svId, bool health, const std::optional<std::string>& dataSetName)
      : CommandResult(CmdName, TargetId)
    {
    ...
    GetQzssL1HealthForSVResult::GetQzssL1HealthForSVResult(CommandBasePtr relatedCommand, int svId, bool health, const std::optional<std::string>& dataSetName)
    ...
    GetQzssL1HealthForSVResultPtr GetQzssL1HealthForSVResult::create(int svId, bool health, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<GetQzssL1HealthForSVResult>(svId, health, dataSetName);
    }

    GetQzssL1HealthForSVResultPtr GetQzssL1HealthForSVResult::create(CommandBasePtr relatedCommand, int svId, bool health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetQzssL1HealthForSVResult::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetQzssL1HealthForSVResult::setDataSetName(const std::optional<std::string>& dataSetName)
    {
