...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetModificationToGpsCNav2Message;
    typedef std::shared_ptr<SetModificationToGpsCNav2Message> SetModificationToGpsCNav2MessagePtr;
    
    
    class SetModificationToGpsCNav2Message : public CommandBase
    {
    public:
      ...
      SetModificationToGpsCNav2Message();

      SetModificationToGpsCNav2Message(int prn, int startTime, int stopTime, int pageId, const std::string& condition, bool updateCRC, const std::string& bitsMods, const std::string& id);
  
      static SetModificationToGpsCNav2MessagePtr create(int prn, int startTime, int stopTime, int pageId, const std::string& condition, bool updateCRC, const std::string& bitsMods, const std::string& id);
      static SetModificationToGpsCNav2MessagePtr dynamicCast(CommandBasePtr ptr);
