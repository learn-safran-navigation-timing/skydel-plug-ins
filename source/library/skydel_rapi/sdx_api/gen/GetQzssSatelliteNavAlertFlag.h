...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetQzssSatelliteNavAlertFlag(int svId, const std::optional<std::string>& dataSetName = {});

      static GetQzssSatelliteNavAlertFlagPtr create(int svId, const std::optional<std::string>& dataSetName = {});
