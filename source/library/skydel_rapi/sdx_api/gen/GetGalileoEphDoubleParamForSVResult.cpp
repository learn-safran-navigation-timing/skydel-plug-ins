...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGalileoEphDoubleParamForSVResult::GetGalileoEphDoubleParamForSVResult(int svId, const std::string& paramName, double val, const std::optional<std::string>& dataSetName)
      : CommandResult(CmdName, TargetId)
    {
    ...
    GetGalileoEphDoubleParamForSVResult::GetGalileoEphDoubleParamForSVResult(CommandBasePtr relatedCommand, int svId, const std::string& paramName, double val, const std::optional<std::string>& dataSetName)
    ...
    GetGalileoEphDoubleParamForSVResultPtr GetGalileoEphDoubleParamForSVResult::create(int svId, const std::string& paramName, double val, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<GetGalileoEphDoubleParamForSVResult>(svId, paramName, val, dataSetName);
    }

    GetGalileoEphDoubleParamForSVResultPtr GetGalileoEphDoubleParamForSVResult::create(CommandBasePtr relatedCommand, int svId, const std::string& paramName, double val, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGalileoEphDoubleParamForSVResult::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGalileoEphDoubleParamForSVResult::setDataSetName(const std::optional<std::string>& dataSetName)
    {
