...
#include "SetMessageModificationToGpsCNav2.h"
...
namespace Sdx
{
  namespace Cmd
  {
    ...
    const char* const SetMessageModificationToGpsCNav2::TargetId = "";

    REGISTER_COMMAND_TO_FACTORY_DECL(SetMessageModificationToGpsCNav2);
    REGISTER_COMMAND_TO_FACTORY_IMPL(SetMessageModificationToGpsCNav2);
    ...
    const std::vector<std::string>& SetMessageModificationToGpsCNav2::fieldNames() const 
    { 
