...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetBeiDouHealthInfoForSV(int svId, int health, const std::optional<std::string>& dataSetName = {});

      static SetBeiDouHealthInfoForSVPtr create(int svId, int health, const std::optional<std::string>& dataSetName = {});
