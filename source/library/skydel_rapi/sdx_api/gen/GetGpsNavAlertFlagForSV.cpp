...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGpsNavAlertFlagForSV::GetGpsNavAlertFlagForSV(int svId, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetGpsNavAlertFlagForSVPtr GetGpsNavAlertFlagForSV::create(int svId, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGpsNavAlertFlagForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGpsNavAlertFlagForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
