...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGpsDataHealthForSV::GetGpsDataHealthForSV(int svId, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetGpsDataHealthForSVPtr GetGpsDataHealthForSV::create(int svId, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGpsDataHealthForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGpsDataHealthForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
