...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class GetNavICEphemerisDoubleParam;
    typedef std::shared_ptr<GetNavICEphemerisDoubleParam> GetNavICEphemerisDoubleParamPtr;
    
    
    class GetNavICEphemerisDoubleParam : public CommandBase
    {
    public:
      ...
      GetNavICEphemerisDoubleParam(int svId, const std::string& paramName, const std::optional<std::string>& dataSetName = {});

      static GetNavICEphemerisDoubleParamPtr create(int svId, const std::string& paramName, const std::optional<std::string>& dataSetName = {});
