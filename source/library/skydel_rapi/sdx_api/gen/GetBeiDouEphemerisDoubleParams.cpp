...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetBeiDouEphemerisDoubleParams::GetBeiDouEphemerisDoubleParams(const std::string& paramName, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetBeiDouEphemerisDoubleParamsPtr GetBeiDouEphemerisDoubleParams::create(const std::string& paramName, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetBeiDouEphemerisDoubleParams::deprecated() const { return std::optional<std::string>{Deprecated}; }
    ...
    std::optional<std::string> GetBeiDouEphemerisDoubleParams::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetBeiDouEphemerisDoubleParams::setDataSetName(const std::optional<std::string>& dataSetName)
    {
