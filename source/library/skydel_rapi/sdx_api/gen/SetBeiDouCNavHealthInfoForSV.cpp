...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetBeiDouCNavHealthInfoForSV::SetBeiDouCNavHealthInfoForSV(int svId, int health, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetBeiDouCNavHealthInfoForSVPtr SetBeiDouCNavHealthInfoForSV::create(int svId, int health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetBeiDouCNavHealthInfoForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetBeiDouCNavHealthInfoForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
