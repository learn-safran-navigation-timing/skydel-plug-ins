...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetQzssSatelliteL1DataHealth::SetQzssSatelliteL1DataHealth(int svId, int health, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetQzssSatelliteL1DataHealthPtr SetQzssSatelliteL1DataHealth::create(int svId, int health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetQzssSatelliteL1DataHealth::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetQzssSatelliteL1DataHealth::setDataSetName(const std::optional<std::string>& dataSetName)
    {
