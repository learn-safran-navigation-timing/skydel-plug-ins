...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetGpsNavAlertFlagForSV::SetGpsNavAlertFlagForSV(int svId, bool alert, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetGpsNavAlertFlagForSVPtr SetGpsNavAlertFlagForSV::create(int svId, bool alert, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetGpsNavAlertFlagForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetGpsNavAlertFlagForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
