...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetMessageModificationToSbasNav;
    typedef std::shared_ptr<SetMessageModificationToSbasNav> SetMessageModificationToSbasNavPtr;
    
    
    class SetMessageModificationToSbasNav : public CommandBase
    {
    public:
      ...
      SetMessageModificationToSbasNav();

      SetMessageModificationToSbasNav(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, int messageType, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);

      static SetMessageModificationToSbasNavPtr create(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, int messageType, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);
      static SetMessageModificationToSbasNavPtr dynamicCast(CommandBasePtr ptr);
