...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetModificationToBeiDouCNav2Message;
    typedef std::shared_ptr<SetModificationToBeiDouCNav2Message> SetModificationToBeiDouCNav2MessagePtr;
    
    
    class SetModificationToBeiDouCNav2Message : public CommandBase
    {
    public:
      ...
      SetModificationToBeiDouCNav2Message();

      SetModificationToBeiDouCNav2Message(int prn, int startTime, int stopTime, int messageType, const std::string& condition, bool updateCRC, const std::string& bitsMods, const std::string& id);
  
      static SetModificationToBeiDouCNav2MessagePtr create(int prn, int startTime, int stopTime, int messageType, const std::string& condition, bool updateCRC, const std::string& bitsMods, const std::string& id);
      static SetModificationToBeiDouCNav2MessagePtr dynamicCast(CommandBasePtr ptr);
