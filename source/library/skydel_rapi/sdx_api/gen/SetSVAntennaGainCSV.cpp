...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetSVAntennaGainCSV::SetSVAntennaGainCSV(const std::string& filePath, const Sdx::AntennaPatternType& type, const Sdx::GNSSBand& band, const std::string& system, const std::optional<std::string>& name)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetSVAntennaGainCSVPtr SetSVAntennaGainCSV::create(const std::string& filePath, const Sdx::AntennaPatternType& type, const Sdx::GNSSBand& band, const std::string& system, const std::optional<std::string>& name)
    {
    ...
    std::optional<std::string> SetSVAntennaGainCSV::name() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["Name"]);
    }

    void SetSVAntennaGainCSV::setName(const std::optional<std::string>& name)
    {
