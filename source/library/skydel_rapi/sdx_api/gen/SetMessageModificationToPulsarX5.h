...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetMessageModificationToPulsarX5;
    typedef std::shared_ptr<SetMessageModificationToPulsarX5> SetMessageModificationToPulsarX5Ptr;
    
    
    class SetMessageModificationToPulsarX5 : public CommandBase
    {
    public:
      ...
      SetMessageModificationToPulsarX5();

      SetMessageModificationToPulsarX5(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);

      static SetMessageModificationToPulsarX5Ptr create(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);
      static SetMessageModificationToPulsarX5Ptr dynamicCast(CommandBasePtr ptr);
