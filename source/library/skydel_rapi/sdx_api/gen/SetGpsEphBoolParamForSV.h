...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetGpsEphBoolParamForSV(int svId, const std::string& paramName, bool val, const std::optional<std::string>& dataSetName = {});

      static SetGpsEphBoolParamForSVPtr create(int svId, const std::string& paramName, bool val, const std::optional<std::string>& dataSetName = {});
