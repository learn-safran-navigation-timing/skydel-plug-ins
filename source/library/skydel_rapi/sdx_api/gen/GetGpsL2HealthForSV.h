...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetGpsL2HealthForSV(int svId, const Sdx::optional<std::string>& dataSetName = {});

      static GetGpsL2HealthForSVPtr create(int svId, const Sdx::optional<std::string>& dataSetName = {});
