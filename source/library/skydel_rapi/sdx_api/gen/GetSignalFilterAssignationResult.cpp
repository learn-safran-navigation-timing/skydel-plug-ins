...
namespace Sdx
{
  namespace Cmd
  {
    ...
    const char* const GetSignalFilterAssignationResult::Documentation = "Result of GetSignalFilterAssignation.\n"
      ...
      "                                                       \"L2MR\", \"L5\", \"G1\", \"G1P\", \"G2\", \"G2P\", \"E1\", \"E1PRS\", \"E5a\",\n"
      "                                                       \"E5b\", \"E5AltBOC\", \"E6BC\", \"E6PRS\", \"B1\", \"B2\", \"B1C\", \"B2a\",\n"
    ...
    {
      setValue("SignalFilterDict", parse_json<std::map<std::string, std::string>>::format(signalFilterDict, m_values.GetAllocator()));
    }
