...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetSbasMonitoredSystems(const std::optional<std::string>& serviceProvider = {});

      static GetSbasMonitoredSystemsPtr create(const std::optional<std::string>& serviceProvider = {});
