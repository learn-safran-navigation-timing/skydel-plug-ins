...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetQzssSatelliteL1Health(int svId, bool health, const std::optional<std::string>& dataSetName = {});

      static SetQzssSatelliteL1HealthPtr create(int svId, bool health, const std::optional<std::string>& dataSetName = {});
