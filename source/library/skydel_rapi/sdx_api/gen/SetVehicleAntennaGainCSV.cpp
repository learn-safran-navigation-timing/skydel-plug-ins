...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetVehicleAntennaGainCSV::SetVehicleAntennaGainCSV(const std::string& filePath, const Sdx::AntennaPatternType& type, const Sdx::GNSSBand& band, const std::optional<std::string>& name)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetVehicleAntennaGainCSVPtr SetVehicleAntennaGainCSV::create(const std::string& filePath, const Sdx::AntennaPatternType& type, const Sdx::GNSSBand& band, const std::optional<std::string>& name)
    {
    ...
    std::optional<std::string> SetVehicleAntennaGainCSV::name() const
    {
