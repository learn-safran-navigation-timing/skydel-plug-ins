...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetModificationToBeiDouD1NavigationMessage;
    typedef std::shared_ptr<SetModificationToBeiDouD1NavigationMessage> SetModificationToBeiDouD1NavigationMessagePtr;
    
    
    class SetModificationToBeiDouD1NavigationMessage : public CommandBase
    {
    public:
      ...
      SetModificationToBeiDouD1NavigationMessage();

      SetModificationToBeiDouD1NavigationMessage(int prn, int startTime, int stopTime, int subFrame, int page, int word, bool updateParity, const std::string& modification, const std::string& id);
  
      static SetModificationToBeiDouD1NavigationMessagePtr create(int prn, int startTime, int stopTime, int subFrame, int page, int word, bool updateParity, const std::string& modification, const std::string& id);
      static SetModificationToBeiDouD1NavigationMessagePtr dynamicCast(CommandBasePtr ptr);
