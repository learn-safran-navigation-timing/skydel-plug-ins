...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetBeiDouUraIndexForSV::SetBeiDouUraIndexForSV(int svId, int urai, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetBeiDouUraIndexForSVPtr SetBeiDouUraIndexForSV::create(int svId, int urai, const std::optional<std::string>& dataSetName)
    {
    ...
    {
      setValue("Urai", parse_json<int>::format(urai, m_values.GetAllocator()));
    }



    std::optional<std::string> SetBeiDouUraIndexForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetBeiDouUraIndexForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
