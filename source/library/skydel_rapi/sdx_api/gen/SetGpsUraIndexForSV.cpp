...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetGpsUraIndexForSV::SetGpsUraIndexForSV(int svId, int urai, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetGpsUraIndexForSVPtr SetGpsUraIndexForSV::create(int svId, int urai, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetGpsUraIndexForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetGpsUraIndexForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
