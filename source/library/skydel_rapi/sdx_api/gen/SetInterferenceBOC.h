...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetInterferenceBOC(int startTime, int stopTime, double centralFreq, double power, int codeRate, int codeLengthMs, int subCarrierRate, bool cosinePhaseBoc, bool enabled, const std::string& id, const std::optional<int>& prn = {});

      static SetInterferenceBOCPtr create(int startTime, int stopTime, double centralFreq, double power, int codeRate, int codeLengthMs, int subCarrierRate, bool cosinePhaseBoc, bool enabled, const std::string& id, const std::optional<int>& prn = {});
