...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGpsSignalHealthForSVResult::GetGpsSignalHealthForSVResult(int svId, int health, const std::optional<std::string>& dataSetName)
      : CommandResult(CmdName, TargetId)
    {
    ...
    GetGpsSignalHealthForSVResult::GetGpsSignalHealthForSVResult(CommandBasePtr relatedCommand, int svId, int health, const std::optional<std::string>& dataSetName)
    ...
    GetGpsSignalHealthForSVResultPtr GetGpsSignalHealthForSVResult::create(int svId, int health, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<GetGpsSignalHealthForSVResult>(svId, health, dataSetName);
    }

    GetGpsSignalHealthForSVResultPtr GetGpsSignalHealthForSVResult::create(CommandBasePtr relatedCommand, int svId, int health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGpsSignalHealthForSVResult::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGpsSignalHealthForSVResult::setDataSetName(const std::optional<std::string>& dataSetName)
    {
