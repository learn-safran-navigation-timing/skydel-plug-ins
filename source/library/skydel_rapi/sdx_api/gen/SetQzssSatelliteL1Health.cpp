...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetQzssSatelliteL1Health::SetQzssSatelliteL1Health(int svId, bool health, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetQzssSatelliteL1HealthPtr SetQzssSatelliteL1Health::create(int svId, bool health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetQzssSatelliteL1Health::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetQzssSatelliteL1Health::setDataSetName(const std::optional<std::string>& dataSetName)
    {
