...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetBeiDouHealthInfoForSV(int svId, const Sdx::optional<std::string>& dataSetName = {});

      static GetBeiDouHealthInfoForSVPtr create(int svId, const Sdx::optional<std::string>& dataSetName = {});
