...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetGpsL5HealthForSV(int svId, const std::optional<std::string>& dataSetName = {});

      static GetGpsL5HealthForSVPtr create(int svId, const std::optional<std::string>& dataSetName = {});
