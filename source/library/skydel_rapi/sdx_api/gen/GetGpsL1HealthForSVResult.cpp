...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGpsL1HealthForSVResult::GetGpsL1HealthForSVResult(int svId, bool health, const std::optional<std::string>& dataSetName)
      : CommandResult(CmdName, TargetId)
    {
    ...
    GetGpsL1HealthForSVResult::GetGpsL1HealthForSVResult(CommandBasePtr relatedCommand, int svId, bool health, const std::optional<std::string>& dataSetName)
    ...
    GetGpsL1HealthForSVResultPtr GetGpsL1HealthForSVResult::create(int svId, bool health, const std::optional<std::string>& dataSetName)
    {
      return std::make_shared<GetGpsL1HealthForSVResult>(svId, health, dataSetName);
    }

    GetGpsL1HealthForSVResultPtr GetGpsL1HealthForSVResult::create(CommandBasePtr relatedCommand, int svId, bool health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGpsL1HealthForSVResult::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGpsL1HealthForSVResult::setDataSetName(const std::optional<std::string>& dataSetName)
    {
