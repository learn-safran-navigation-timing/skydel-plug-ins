...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      SetQzssNavAlertFlagForSV(int svId, bool alert, const std::optional<std::string>& dataSetName = {});

      static SetQzssNavAlertFlagForSVPtr create(int svId, bool alert, const std::optional<std::string>& dataSetName = {});
