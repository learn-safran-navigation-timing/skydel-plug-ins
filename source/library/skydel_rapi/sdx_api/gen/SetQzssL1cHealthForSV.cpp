...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetQzssL1cHealthForSV::SetQzssL1cHealthForSV(int svId, bool health, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetQzssL1cHealthForSVPtr SetQzssL1cHealthForSV::create(int svId, bool health, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> SetQzssL1cHealthForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetQzssL1cHealthForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
