...
#include "SetGlonassEphDoubleParamForSV.h"
...
namespace Sdx
{
  namespace Cmd
  {
    ...
    const char* const SetGlonassEphDoubleParamForSV::TargetId = "";

    REGISTER_COMMAND_TO_FACTORY_DECL(SetGlonassEphDoubleParamForSV);
    REGISTER_COMMAND_TO_FACTORY_IMPL(SetGlonassEphDoubleParamForSV);
    ...
    const std::vector<std::string>& SetGlonassEphDoubleParamForSV::fieldNames() const 
    { 
