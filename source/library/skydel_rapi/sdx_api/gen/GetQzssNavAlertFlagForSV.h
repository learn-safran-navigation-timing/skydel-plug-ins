...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      GetQzssNavAlertFlagForSV(int svId, const std::optional<std::string>& dataSetName = {});

      static GetQzssNavAlertFlagForSVPtr create(int svId, const std::optional<std::string>& dataSetName = {});
