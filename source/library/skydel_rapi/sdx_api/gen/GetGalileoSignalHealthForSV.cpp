...
namespace Sdx
{
  namespace Cmd
  {
    ...
    GetGalileoSignalHealthForSV::GetGalileoSignalHealthForSV(int svId, const std::string& component, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    GetGalileoSignalHealthForSVPtr GetGalileoSignalHealthForSV::create(int svId, const std::string& component, const std::optional<std::string>& dataSetName)
    {
    ...
    std::optional<std::string> GetGalileoSignalHealthForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void GetGalileoSignalHealthForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
