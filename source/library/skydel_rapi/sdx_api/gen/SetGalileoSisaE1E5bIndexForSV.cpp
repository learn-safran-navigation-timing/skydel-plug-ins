...
namespace Sdx
{
  namespace Cmd
  {
    ...
    SetGalileoSisaE1E5bIndexForSV::SetGalileoSisaE1E5bIndexForSV(int svId, int sisai, const std::optional<std::string>& dataSetName)
      : CommandBase(CmdName, TargetId)
    {
    ...
    SetGalileoSisaE1E5bIndexForSVPtr SetGalileoSisaE1E5bIndexForSV::create(int svId, int sisai, const std::optional<std::string>& dataSetName)
    {
    ...
    {
      setValue("Sisai", parse_json<int>::format(sisai, m_values.GetAllocator()));
    }



    std::optional<std::string> SetGalileoSisaE1E5bIndexForSV::dataSetName() const
    {
      return parse_json<std::optional<std::string>>::parse(m_values["DataSetName"]);
    }

    void SetGalileoSisaE1E5bIndexForSV::setDataSetName(const std::optional<std::string>& dataSetName)
    {
