...
#include "SetMessageModificationToGpsCNav.h"
...
namespace Sdx
{
  namespace Cmd
  {
    ...
    const char* const SetMessageModificationToGpsCNav::TargetId = "";

    REGISTER_COMMAND_TO_FACTORY_DECL(SetMessageModificationToGpsCNav);
    REGISTER_COMMAND_TO_FACTORY_IMPL(SetMessageModificationToGpsCNav);
    ...
    const std::vector<std::string>& SetMessageModificationToGpsCNav::fieldNames() const 
    { 
