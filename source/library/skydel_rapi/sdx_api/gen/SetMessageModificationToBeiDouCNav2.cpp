...
#include "SetMessageModificationToBeiDouCNav2.h"
...
namespace Sdx
{
  namespace Cmd
  {
    ...
    const char* const SetMessageModificationToBeiDouCNav2::TargetId = "";

    REGISTER_COMMAND_TO_FACTORY_DECL(SetMessageModificationToBeiDouCNav2);
    REGISTER_COMMAND_TO_FACTORY_IMPL(SetMessageModificationToBeiDouCNav2);
    ...
    const std::vector<std::string>& SetMessageModificationToBeiDouCNav2::fieldNames() const 
    { 
