...
namespace Sdx
{
  namespace Cmd
  {
    ...
    class SetMessageModificationToQzssSlas;
    typedef std::shared_ptr<SetMessageModificationToQzssSlas> SetMessageModificationToQzssSlasPtr;
    
    
    class SetMessageModificationToQzssSlas : public CommandBase
    {
    public:
      ...
      SetMessageModificationToQzssSlas(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, int messageType, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);

      static SetMessageModificationToQzssSlasPtr create(const std::vector<std::string>& signalArray, int svId, int startTime, int stopTime, int messageType, const std::string& condition, bool updateCRC, const std::string& bitModifications, const std::string& id);
      static SetMessageModificationToQzssSlasPtr dynamicCast(CommandBasePtr ptr);
