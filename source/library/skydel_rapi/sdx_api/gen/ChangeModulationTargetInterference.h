...
namespace Sdx
{
  namespace Cmd
  {
    ...
    public:
      ...
      ChangeModulationTargetInterference(int output, int minRate, int maxRate, int group, double centralFreq, int gain, const std::string& id, const std::optional<std::string>& signal = {});

      static ChangeModulationTargetInterferencePtr create(int output, int minRate, int maxRate, int group, double centralFreq, int gain, const std::string& id, const std::optional<std::string>& signal = {});
