...
SimplePlugin::SimplePlugin(QObject *parent) :
  QObject(parent),
  m_notificationMessage("Hello Skydel!"),
  m_notificationType(SkydelNotifierInterface::Type::WARNING)
{}
...
{
  return { { "message", m_notificationMessage },
           { "type", static_cast<int>(m_notificationType) } };
}
...
SimplePluginFactory::SimplePluginFactory(QObject *parent) :
  QObject(parent)
{}
